...
function validateCourseForm(form) {
    ...
    const errorIds = ['error-code', 'error-course_name', 'error-course_description', 'error-edit_code', 'error-edit_course_name', 'error-edit_course_description'];
    errorIds.forEach(id => {
    ...
    if (!hasValidVideo && videoUrlFields.length > 0) {
        ...
        if (firstVideoField) {
            ...
            firstVideoField.style.borderColor = '#dc3545';
...
function showCourseFieldError(field, message) {
    ...
    const container = field.closest('.video-url-field') || field.closest('.form-group') || field.parentNode;
    ...
    // Шукаємо у всьому контейнері та у всій формі
    ...
    forms.forEach(form => {
        ...
        fields.forEach(field => {
            ...
            field.addEventListener('input', function() {
                ...
                const container = this.closest('.video-url-field') || this.closest('.form-group') || this.parentNode;
